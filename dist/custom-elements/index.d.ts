...
interface ResponsiveDataGrid extends Components.ResponsiveDataGrid, HTMLElement {}
export const ResponsiveDataGrid: {
  prototype: ResponsiveDataGrid;
  new (): ResponsiveDataGrid;
};
